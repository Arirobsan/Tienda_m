...
public class PruebasController {
    ...
    public String consultaQuery4(
            @RequestParam(value = "cantInf") int cantInf,
            @RequestParam(value = "cantSup") int cantSup,
            Model model) {

        var lista = productoService.metodoJPAE(cantInf, cantSup);
        model.addAttribute("productos", lista);
        model.addAttribute("cantInf", cantInf);
        model.addAttribute("cantSup", cantSup);
        return "/pruebas/listado2";
    }
